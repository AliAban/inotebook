...
const NoteItem = (props) => {
  ...
  return (
    <div className="card col-md-3 m-1 note" title="Open" style={{}} onClick={()=>{viewNoteModal(note  )}} data-bs-target="#NoteViewModal" data-bs-toggle="modal" >
      <div className="card-body position-relative" style={{zIndex: "1"}} >
        ...
        {/* delete button */}
        <i className="far fa-trash-alt mx-2 position-relative" style={{zIndex: "3 !important" }} onClick={()=>{deleteNote(note._id)}}></i>
        {/* edit button */}
